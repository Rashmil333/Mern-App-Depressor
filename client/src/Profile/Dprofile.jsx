...
import Dprofilecard from "./ProfileCard/Dprofilecard";
			...
			<>
				...
				<div className="container" >
					<div className="row">
						...
						<Dprofilecard
							name="Pooja"
							email="poojasingh333@gmail.com"
							type="Reliever"
							img="https://d3b4rd8qvu76va.cloudfront.net/690/aaa29/8eba/4e1a/964a/7a96e13e54a9/large/72012.jpg"
						/>

						<Button id="text_pink" onClick={getalldata}>Show {toggle === false ? "More" : "Less"}</Button>
						{toggle === true ?
							<>
