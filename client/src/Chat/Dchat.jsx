...
import Dchatbutton from './ChatButton/Dchatbutton';
...
const Dchat = () => {
	...
	// 	console.log('lll',socket.connected)
	// 	socket.on("connect", () => {
	// 		console.log('lll',socket.connected); // true
	// 	  });
	// }, [CONNECTION_PORT]);
			...
			<div className={themee === "red" ? "Dchatredbackground" : themee === "green" ? "Dchatgreenbackground" : themee === "yellow" ? "Dchatbackgroundyellow" : themee === "blue" ?
				...
				{live == "" ? <>
					...
					: live[live.length - 1] === live[live.length - 2] ?
						<img src="https://static.wixstatic.com/media/b29a70_3f4cccf7c48a4e3887aba0b5f3ac21ba~mv2.gif" style={{ width: '150px' }} alt='pic' /> : <>
							<span>......</span>
							<span id="text_white">OOps!!Your family member is not live but still you can send
								<img src="https://i.pinimg.com/originals/49/27/84/4927849d453932ff05aba4fe7a06dd12.gif" style={{ width: '150px' }} alt='pic' />  to him.He will seeeee.. it later.</span>
							<img src="https://media3.giphy.com/media/l4FGrHErakgV8GRO0/giphy.gif" style={{ width: '150px' }} alt='pic' />
						</>
				}
				...
				{validchat < 0 ?
					<button id="Dchatbutton" style={{ position: 'fixed', bottom: '0', marginLeft: '65%', color: 'green', backgroundColor: 'yellow', opacity: '0.4', borderRadius: '20px', outline: 'none', border: 'none', width: '50px', height: '37px' }} onClick={() => alert('You cannot say negative!!! Sorry')} ><SendIcon style={{}} /></button>
					:
