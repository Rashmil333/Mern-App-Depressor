...
import Dlive from "./Components/Live/Dlive";
	...
	return (<>
		<div style={{ backgroundColor: 'white', width: '100vw', overflow: 'hidden' }}>
			...
			<div class="section">
				...
				<img src={bird1} id="bird1" alt="pic" />
				<img src={bird2} id="bird2" alt="pic" />
				<img src={forest} id="forest" alt="pic" />
				<a href="/login" id="btn" >Explore</a>
				<img src={rocks} id="rocks" alt="pic" />
				<img src={water} id="water" alt="pic" />
			...
			<div class="sec">
				...
				<div id='fish1' style={{ marginTop: '50px' }}>
					<img src="https://i.pinimg.com/originals/60/27/f9/6027f9062950613ce3f1e99c05f39b98.gif"
						style={{ width: '140px', height: '100px' }} alt="pic" />
				</div>
				<br />
