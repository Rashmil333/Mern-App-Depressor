    ...
    <>
      <div className="blackSky">
        ...
        <div className="flexdiv">
          <img src={logoWho} className="Image" alt='pic' />
        ...
        <div className="flexdiv">
          ...
          <img src={logoWho} className="Image" style={{ marginLeft: "20%" }} alt='pic' />
        </div>
