...
const Dmedisci=()=>{
	...
	return(<>
		<div className="container" style={{textAlign:'justify',color:'white',paddingLeft:'25px',paddingRight:'25px'}} id="selfhealdatadiv">	
		  <div className="row">
			<h1 style={{textAlign:'center'}} id="text_pink">Science of Meditation</h1><br/>
				<Dcardselfhealing img="https://isha.sadhguru.org/yoga/wp-content/uploads/2017/04/Science-of-Meditation-49951022-c.jpg"/><br/><br/>
				Physical manifestations are probably always the most tangible. There are many physical and psychological manifestations and there are many other manifestations which are beyond physical and psychological. All these things can be questioned, but by whom? People who know only the physical and psychological, people who rely more on machines, who believe that machines are more reliable than the human beings who built them, those type of people question it all the time.<br/><br/>
				<h3 style={{textAlign:'center'}} id="text_pink">Dead or Brain-dead?!</h3><br/><br/>
