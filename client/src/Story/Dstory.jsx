...
import Dcardstory from "./CardStory/Dcardstory";
  ...
  return (<>
    ...
    <div style={{ backgroundColor: '#10182f' }}>
      ...
      <div className="container" >
        <a style={{
          marginLeft: '25%', color: 'white', textDecoration: 'none', backgroundColor: '#6564fd'
          , padding: '10px', borderRadius: '10px'
        }} href="#skip">Share your story<ArrowDownwardIcon /></a>
        <div className="row">
          <div className="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12" >
            <div className="container">
              <div className="row">
                ...
                {stories.map((cvalue) => {
                  return (<Dcardstory story_id={cvalue.story_id} story={cvalue.story} email={cvalue.email} imgr={cvalue.img_reliever} category={cvalue.category} id={cvalue._id} depressor_img={cvalue.img_depressor} />)
                })}
